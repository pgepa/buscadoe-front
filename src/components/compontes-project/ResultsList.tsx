    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center h-screen">
                <div className='h-16 w-16 border-4 border-l-violet-200 border-r-violet-200 border-b-violet-200 border-t-violet-500 animate-spin ease-linear rounded-full'></div>
            </div>
        );
    }
